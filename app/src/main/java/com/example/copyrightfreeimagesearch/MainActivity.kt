...
import com.example.copyrightfreeimagesearch.data.Repository
import com.example.copyrightfreeimagesearch.data.models.PhotoResponse
import com.example.copyrightfreeimagesearch.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun bindViews() {
        ...
        binding.refreshLayout.setOnRefreshListener {
            fetchRandomPhotos(binding.etSearch.text.toString())
        }

        (binding.recyclerView.adapter as? PhotoAdapter)?.onClickPhoto = {
